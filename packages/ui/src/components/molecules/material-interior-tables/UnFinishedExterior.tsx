...
const tblParams = [
    {
        key: 'unfinished_exterior',
        label: 'Unifinished Exterior',
    },
]

export default function UnFinishedExterior({
    onChange,
    ...
    const columns = [
        ...
        {
            title: 'Unfinished Interior Finished End Material',
        ...
        {
            title: 'Unfinished Interior Finished Bottom Material',
