...
export class Initial1675136289132 implements MigrationInterface {
  name = "Initial1675136289132";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "account" ("id" SERIAL NOT NULL, "name" text NOT NULL, "email" text NOT NULL, "password" text, "salt" text, "role" text NOT NULL DEFAULT 'sales', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "preferences_id" integer, "stripe_key" text, "company_name" text NOT NULL, "company_contact_name" text, "company_logo" text, CONSTRAINT "UQ_4c8f96ccf523e9a3faefd5bdd4c" UNIQUE ("email"), CONSTRAINT "REL_35f5ce85c1ef8f032df1311b45" UNIQUE ("preferences_id"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "filler" ("id" SERIAL NOT NULL, "depth" real NOT NULL, "room_id" integer, CONSTRAINT "PK_9853d92975791b2161c09774a72" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "panel" ("id" SERIAL NOT NULL, "type" text NOT NULL, "height" real NOT NULL, "panels_count" integer, "width" real, "cabinet_type" text, "depth" real, "account_id" integer, "room_id" integer, CONSTRAINT "PK_bbd5674b69f7448974aa41ab347" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "room" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "total_price" real NOT NULL DEFAULT '0', "name" text NOT NULL, "elevation" text, "status" text NOT NULL DEFAULT 'estimate', "job_id" integer NOT NULL, "material_set_id" integer, "hardware_set_id" integer, "account_id" integer, CONSTRAINT "REL_12dd210e46c2e7082542370659" UNIQUE ("material_set_id"), CONSTRAINT "REL_5413f589e26d684ee473be324b" UNIQUE ("hardware_set_id"), CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "accessory" ("id" SERIAL NOT NULL, "type" text NOT NULL, "classification" text NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "material_cost" real NOT NULL, "discount" real, "shop_labor_cost" real NOT NULL, "installation_labor_cost" real NOT NULL, "unit_of_measurement" text NOT NULL DEFAULT 'each', "report" boolean NOT NULL DEFAULT true, "category" text NOT NULL, "room_id" integer, CONSTRAINT "PK_e1ead99f958789eeebd86246d74" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "hardware" ("id" SERIAL NOT NULL, "type" text NOT NULL, "classification" text NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "material_cost" real NOT NULL, "discount" real, "shop_labor_cost" real NOT NULL, "installation_labor_cost" real NOT NULL, "unit_of_measurement" text NOT NULL DEFAULT 'each', "report" boolean NOT NULL DEFAULT true, "category" text NOT NULL, "room_id" integer, CONSTRAINT "PK_3334ecf6c630e1fb3442e88a31e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "letter" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "body" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "account_id" integer, CONSTRAINT "PK_7a85cf0e444dff7c656a31b32bf" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "material" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "is_default" boolean NOT NULL DEFAULT false, "purpose" text NOT NULL, "source" text NOT NULL, "name" text NOT NULL, "type" text NOT NULL, "description" text NOT NULL, "price" real NOT NULL, "discount" real NOT NULL, "waste_factor" real NOT NULL, "labor_cost" real NOT NULL, "is_finished" boolean NOT NULL, "length_of_roll" integer, "vendor_id" uuid, CONSTRAINT "PK_0343d0d577f3effc2054cbaca7f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_75fa86245e05268a3abfe93bd4" ON "material" ("purpose") `
    );
    await queryRunner.query(
      `CREATE TABLE "vendor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "account_id" integer, CONSTRAINT "PK_931a23f6231a57604f5a0e32780" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "cabinet_opening" ("id" SERIAL NOT NULL, "type" text NOT NULL, "model_name" text NOT NULL, "price" real NOT NULL, "discount" real NOT NULL, "vendor_id" uuid, CONSTRAINT "PK_da372022eb4321795c4bf624f8b" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
