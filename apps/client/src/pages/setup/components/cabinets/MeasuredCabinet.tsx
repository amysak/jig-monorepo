...
//       <Form.Item name="favourite" valuePropName="checked" label="Favourite">
//         <Checkbox />
//       </Form.Item>
...
//               <Select>
//                 {["blind", "diagonal", "90 degree"].map((value) => (
...
//         <InputNumber min={0} />
//       </Form.Item>
//       <Form.Item name="number_of_drawer_fronts" label="Number of Drawer Fronts">
//         <InputNumber max={5} min={0} />
//       </Form.Item>

//       <Form.Item label="Number of Drawer Boxes" name="number_of_drawers_boxes">
//         <InputNumber max={5} min={0} />
//       </Form.Item>
