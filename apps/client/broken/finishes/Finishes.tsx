...
//             onRow={(row) => {
//               return {
//                 onClick: () => navigate(`/cabinet-setup/finishes/${row.id}`),
//               };
//             }}
//           />
//         </Form.Item>
...
//           discounted_material_cost_per_square_feet: discountedMatCostPerSqFt,
//         });
//         //@ts-ignore
...
//                     <Title level={4}>Finish Material Cost per Sq. Ft.</Title>
...
//                         const costPerSide =
//                           safeNum(
//                             form.getFieldValue("finishing_cost_two_sides")
//                           ) / 2;
...
//                             form.getFieldValue("finishing_cost_two_sides")
//                           ) / 2;
//                         const disountPrice = calcDiscountSalePrice(
//                           costPerSide,
//                           form.getFieldValue("supplier_discount")
//                         );

//                         return `$${toFixed(disountPrice)}`;
//                       }}
//                     </Form.Item>
...
//                             help="X"
//                           >
//                             <InputNumber {...inputNumberCostProps} disabled />
//                           </Form.Item>
//                         </Col>
//                       </Row>
//                     </Form.Item>
...
//                           <Form.Item shouldUpdate>
//                             {() => {
//                               const inHouseLaborCost = safeNum(
//                                 form.getFieldValue(
//                                   "in_house_finishing_labor_cost"
//                                 )
//                               );
//                               const squareFeet = safeNum(
//                                 form.getFieldValue(
...
//                               const laborCost =
//                                 (inHouseLaborCost * squareFeet) / 100;

//                               return `$${toFixed(laborCost)}`;
//                             }}
//                           </Form.Item>
//                         </Col>
//                       </Row>
...
//                   <Col span={12} className="bordered-row">
//                     <Title level={4}>Finish Material Cost per Part</Title>
...
//                           <Form.Item shouldUpdate>
//                             {() => {
//                               const outsourced = safeNum(
//                                 form.getFieldValue(
//                                   "outsourced_cost_per_parts_of_two_sides"
//                                 )
//                               );
//                               const percentPerPart = safeNum(
//                                 form.getFieldValue("simple_percent_per_part")
//                               );
//                               const simplePercentPerPart = toFixed(
//                                 (outsourced * percentPerPart) / 100
//                               );
...
//                               return `$${toFixed(simplePercentPerPart / 2)}`;
//                             }}
//                           </Form.Item>
//                         </Col>
//                       </Row>
...
//                               return `$${toFixed(discountedMaterialCost)}`;
//                             }}
//                           </Form.Item>
//                         </Col>
