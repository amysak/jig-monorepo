...
//                 return (
//                   <Select.Option value={material.id} key={material.id}>
//                     {material.name}
//                   </Select.Option>
//                 );
//               })}
...
//         >
//           <Form.Item>
//             <Button loading={loading} htmlType="submit" className="jig-button">
//               Add Material
//             </Button>
//           </Form.Item>
//         </Col>
...
//         <Table
//           title={() => (
//             <Title level={4}>{capitalize(door?.category)} Material</Title>
//           )}
//           columns={columns}
