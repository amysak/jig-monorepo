...
//       <Col xs={12} md={6} lg={4}>
//         <Form.Item label="Minimum Square Foot" name="minimum_square_foot">
...
//             <Input.Group compact>
//               <Form.Item name={["hinge_drill", "cost"]} help="Cost">
...
//               </Form.Item>
//               <Form.Item name={["hinge_drill", "quantity"]} help="Qty per door">
//                 <InputNumber />
//               </Form.Item>
//             </Input.Group>
//           </Form.Item>
...
//             <Input.Group compact>
//               <Form.Item name={["arch_top_bottom", "cost"]} help="Cost">
//                 {/* @ts-expect-error TS(2322): Type '{ min: number; step: number; controls: boole... Remove this comment to see the full error message */}
//                 <InputNumber {...inputNumberCostProps} />
//               </Form.Item>
...
//           >
//             <Select>
//               {["Per door/per SF", "Per Linear Inch", "Per Door"].map(
//                 (option) => (
