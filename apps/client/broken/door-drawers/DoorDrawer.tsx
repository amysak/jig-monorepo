...
//           <Statistic formatter={(value) => <Title level={3}>${value}</Title>} />
//         </Form.Item>
//       </div>
//     </div>
//   );
...
//         <Title level={4}>{capitalize(category) || ""} Illustration </Title>
...
//       <div className="profile-image-wrapper">
//         <img
//           src={url || "https://via.placeholder.com/150?text=Missing Image"}
//         />
//       </div>
//     </div>
//   );
...
//                   <Select.Option key={shortId()} value={drawer.value}>
//                     {drawer.label}
//                   </Select.Option>
//                 ))}
//               </Select>
//             </Form.Item>
//             <Form.Item label="Material Type" name={["material_type", "id"]}>
//               <Select>
//                 {buildSelectOptions(
//                   types,
...
//             <Illustation category={door?.category} imageURL={door?.image_url} />
//           </Form>
//         </Col>
...
//                   <Title level={4}>Cost per {capitalize(door?.category)}</Title>
...
//                 <Col span={12}>
//                   <Form.Item label={<SourceTitle />} name="source">
//                     <Radio.Group onChange={onChangeSource}>
//                       {IN_OUT_SOURCE_OPTIONS.map((option) => (
//                         <Radio.Button value={option.value} key={shortId()}>
//                           {option.label}
//                         </Radio.Button>
//                       ))}
//                     </Radio.Group>
...
//                   {isTrayOrDrawerBox(door?.category) ? (
//                     <DrawerBoxFields.DrawerBoxInOut source={source} />
//                   ) : null}
...
//             {isDoorOrDrawerFront(door?.category) && (
//               <DoorFields.DoorMaterials door={door} source={source} />
//             )}
//           </Row>
//         </Col>
//       </Row>
