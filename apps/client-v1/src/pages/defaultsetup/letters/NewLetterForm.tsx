...
function NewLetterForm() {
    ...
    return (
        <Form
            form={form}
            onFinish={onFinish}
            className="new-letter-form"
            {...layout}
        >
            <Title level={4}>New Letter</Title>
            ...
            <Form.Item
                ...
                name="name"
                rules={[
                    { required: true, message: 'Letter name is required.' },
                ]}
            >
                <Input />
            </Form.Item>
...
export default function NewLetterPopup() {
    return (
        <Popover
            placement="leftTop"
            content={<NewLetterForm />}
            trigger="click"
        >
