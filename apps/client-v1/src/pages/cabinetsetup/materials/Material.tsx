                    ...
                    <Table
                        ...
                        onRow={(row) => {
                            return {
                                onClick: () =>
                                    navigate(
                                        `/cabinet-setup/materials/${row.id}`
                                    ),
                            }
                        }}
                    />
        ...
        async (
            ...
            try {
                const in_discounted_cost =
                    lowerCase(values.source) === IN_OUT_SOURCE[0] ||
                    !values.source
                        ? calcDiscount(
                              values.in_house_material_cost,
                              values.waste_factor
                ...
                >
                    ...
                    <Row>
                        ...
                        <Col span={6}>
                            <Form.Item label="Status" name="status">
                                <Select style={inputStyle}>
                                    {ACTIVE_INACTIVE_STATUSES_OPTIONS.map(
                                        (option) => (
                                            <Select.Option
                                                value={option.value}
                                                key={shortId()}
