                                ...
                                <Col span={12}>
                                    <Form.Item label="Category" name="category">
                                        <Select style={input80PercentStyle}>
                                            {HARDWARE_CATEGORIES_OPTIONS.map(
                                                (category) => (
                                                    <Select.Option
                                                        key={shortId()}
                                    ...
                                    <Form.Item label="Classification">
                                        <CreatableSelect
                                            ...
                                            value={{
                                                ...
                                                value: accessory?.classification
                                                    ?.id,
                                            }}
                                            isClearable
                                            onCreateOption={
                                                onCreateClassificationOption
                                            }
