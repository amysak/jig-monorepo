...
import { safeNum, sumCabDrawerProp, toFixed } from '../../../../utilities/utils'
...
export default function DoorSpecification() {
    ...
    const onValuesChange = async (
        ...
        values.cabinet_height =
            safeNum(values.cabinet_height) -
            safeNum(values.floor_to_bottom_of_upper)
            ...
            <Row>
                <Col span={4}>
                    ...
                    <Form.Item label="# of Upper Doors">
                        {/* @ts-expect-error TS(2339): Property 'upper_doors' does not exist on type '{}'... Remove this comment to see the full error message */}
                        {cabinet?.upper_doors || 0}
                    </Form.Item>
                    <Form.Item label="# of Base Doors">
                        {/* @ts-expect-error TS(2339): Property 'base_doors' does not exist on type '{}'. */}
                ...
                <Col span={10}>
                    <Row>
                        ...
                        <Col span={16}>
                            ...
                            {Array.from(
                                Array(cabinet.number_of_drawer_fronts || 0)
                            ).map((_, index: number) => {
                                return (
                                    <Form.Item
                                        key={`${index}`}
                            ...
                            <Form.Item
                                label="Total of Drawer Front Heights"
                                shouldUpdate
                            >
                                {sumCabDrawerProp(
                ...
                <Col span={8}>
                    ...
                    <Form.Item shouldUpdate noStyle>
                        {() => {
                            ...
                            return (
                                <Form.Item
                                    label="Reveal between Doors (Tall Only)"
                                    help="+"
                                >
                                    {form.getFieldValue(
                                        'door_and_drawer_reveal'
                                    )}
                                </Form.Item>
                            )
                        }}
