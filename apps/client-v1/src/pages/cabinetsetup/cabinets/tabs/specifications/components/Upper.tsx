    ...
    return (
        <Row className="">
            <Col span={7}>
                ...
                <Form.Item label="# of Finished Sides">
                    <Row>
                        <Col span={12}>
                            <Form.Item
                                name={[
                                    'number_of_adjusted_shelves_finished_sides',
                                ]}
                            >
                        ...
                        <Col span={12}>
                            <Form.Item
                                name={[
                                    'number_of_fixed_shelves_finished_sides',
                                ]}
                            >
                                <Select style={{ width: '80px' }}>
                                    {[0, 1, 2].map((value) => {
                ...
                <Form.Item label="Difference">
                    <Row>
                        <Col span={12}>
                            <Form.Item
                                name={['depth_difference_adjusted_shelves']}
                            >
                                <InputNumber {...inputProps} />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item
                                name={['depth_difference_fixed_shelves']}
                            >
                                <InputNumber {...inputProps} />
                            </Form.Item>
                        </Col>
                            ...
                            <Form.Item shouldUpdate>
                                {() => {
                                    ...
                                    return (
                                        ...
                                        toFixed(
                                            form.getFieldValue([
                                                'depth_difference_fixed_shelves',
                                            ])
                                        )
                                    )
                                }}
            ...
            <Col span={7}>
                ...
                <Form.Item
                    name="number_of_finished_ends"
                    label="# of Finished Ends"
                >
                    <Select style={{ width: '70px' }}>
                        {[0, 1, 2].map((value) => {
                            return (
