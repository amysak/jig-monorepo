...
import {
    ...
    getAllLinearInchPrice, TGetAllLinearInchPriceData, updateOneLinearInchPrice
} from '../../../../api/linear-inch-price'
import { getSetupMaterialNames, TGetSetupMaterialsData } from '../../../../api/materials'
...
function CostPerDrawerBox({ door, source }) {
    return source === 'in' ? (
        ...
        <>
            ...
            <Col xs={12} md={6} lg={4}>
                <Form.Item
                    label="Minimum Linear Inches"
                    name="minimum_linear_inches"
                >
...
function DrawerBoxOutsourceMatrix({ door }: DrawerBoxOutsourceMatrixProps) {
    ...
    const [linearInchPrices, setLinearInchPrices] = useState<
                    ...
                    return (
                        <Col>
                            <Row justify="space-between" align="middle">
                                <Text strong>
                                    Total: {linearInchPrices[0].length}
                                </Text>
                                <Button
                                    size="small"
                            ...
                            <Row>
                                <Col span={10}>
                                    <Text strong>
                                        {capitalize(door?.category)} Materials
                                    </Text>
                                </Col>
                                <Col span={14}>
                                    <Text strong>
                                        {capitalize(door?.category)} Heights
                                    </Text>
                                </Col>
                            </Row>
                        </Col>
