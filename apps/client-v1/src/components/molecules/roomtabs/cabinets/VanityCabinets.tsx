...
export default function VanityCabinets() {
    const category = 'Vanity'
    ...
    const vanityCabinetsColumns = [
        {
            ...
            render(name, row: { id: any }) {
                return (
                    <Link
                        to={`/rooms/${params.id}/cabinets/vanity-cabinets/overview/${row.id}`}
                    >
                        {name}
                    </Link>
                )
