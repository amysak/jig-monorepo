...
const tblParams = [
    {
        key: 'finished_interior',
        label: 'Finished Interior',
    },
]

export default function FinishedInterior({
    onChange,
    ...
    const columns = [
        ...
        {
            title: 'Finished Interior Material',
            dataIndex: 'material',
            key: 'material',
        ...
        {
            title: 'Finished Interior Back Material',
        ...
        {
            title: 'Finished Interior Shelf Material',
        ...
        {
            title: 'Finished Interior Finish Process',
